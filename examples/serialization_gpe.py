...
def main():
    ...
    serialization.serialize_from_h5ad(
        ...
        connection_coords_list=['coords','predicted_XY','X_x_scanvi','X_umap_scanvi','X_draw_gr'],
